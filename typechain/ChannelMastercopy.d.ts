...
interface ChannelMastercopyInterface extends ethers.utils.Interface {
  functions: {
...
export class ChannelMastercopy extends Contract {
  ...
  interface: ChannelMastercopyInterface;
