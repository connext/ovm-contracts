...
import type { IcmcAdjudicator } from "../IcmcAdjudicator";

export class IcmcAdjudicator__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IcmcAdjudicator {
    return new Contract(address, _abi, signerOrProvider) as IcmcAdjudicator;
  }
}
