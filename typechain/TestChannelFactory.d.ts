...
interface TestChannelFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "createChannelWithoutSetup(address,address)": FunctionFragment;
    "deployChannelProxyWithoutSetup(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "createChannelWithoutSetup",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "deployChannelProxyWithoutSetup",
    values: [string, string]
  ): string;
  encodeFunctionData(
...
export class TestChannelFactory extends Contract {
  ...
  interface: TestChannelFactoryInterface;
  ...
  functions: {
    ...
    createChannelWithoutSetup(
      alice: string,
      bob: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "createChannelWithoutSetup(address,address)"(
      alice: string,
      bob: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    deployChannelProxyWithoutSetup(
      alice: string,
      bob: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "deployChannelProxyWithoutSetup(address,address)"(
      alice: string,
      bob: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
