...
const GetRouterConfigParamsSchema = typebox.Type.Object({
...
const GetRegisteredTransfersParamsSchema = typebox.Type.Object({
    chainId: TChainId,
});
...
const GetRouterConfigParamsSchema$1 = typebox.Type.Intersect([
...
const GetRegisteredTransfersParamsSchema$1 = typebox.Type.Intersect([
...
const PostAdminRetryWithdrawTransactionBodySchema = typebox.Type.Object({
    adminToken: typebox.Type.String(),
    transferId: TBytes32,
});
